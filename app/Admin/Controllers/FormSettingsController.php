...
class FormSettingsController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->text('works_description', '作品说明')->rules('required|max:255')->default('作品说明')->help('如无修改，请填写"作品说明"');
        $form->text('attention', '注意事项')->rules('nullable|max:255')->default('注意事项')->help('如无修改，请填写"注意事项"，留空则在比赛阶段不予显示');
